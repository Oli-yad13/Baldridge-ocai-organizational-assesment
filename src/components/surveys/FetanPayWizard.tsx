...
interface FetanPayWizardProps {
    content: any
    respondentType: 'EMPLOYER' | 'EMPLOYEE'
}

export default function FetanPayWizard({ content, respondentType }: FetanPayWizardProps) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const response = await fetch('/api/surveys/fetan-pay/submit', {
                method: 'POST',
                headers: {
